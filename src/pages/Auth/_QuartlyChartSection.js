...
const QuartlyChartSection = () => {
  ...
  const fetchData = () => {
    request({
      url: `${apiPath.dashboard}/graph?period=quarterly${
        filter.year ? `&year=${filter.year}` : ``
      }`,
      method: "GET",
      onSuccess: ({ data, status }) => {
        setLoading(false);
        console.log(data, "quartly");
        if (status) {
          setData(data);
      ...
      {loading ? (
        ...
        <>
          <Col xs={24} xl={12} lg={24} className="mb-24">
            ...
            >
              <UserQuarterlyChart data={data?.user || []} />
            </SectionWrapper>
          </Col>
          ...
          <Col xs={24} xl={12} lg={24} className="mb-24">
            ...
            >
              <UserQuarterlyChart data={data?.activeUser || []} />
            </SectionWrapper>
          </Col>
          <Col xs={24} xl={12} lg={24} className="mb-24">
            <SectionWrapper
            ...
            >
              <UserQuarterlyChart data={data?.provider || []} />
            </SectionWrapper>
          </Col>
          <Col xs={24} xl={12} lg={24} className="mb-24">
            <SectionWrapper
            ...
            >
              <UserQuarterlyChart data={data?.categories || []} />
            </SectionWrapper>
          </Col>
          <Col xs={24} xl={12} lg={24} className="mb-24">
            <SectionWrapper
            ...
            >
              <UserQuarterlyChart data={data?.events || []} />
            </SectionWrapper>
          </Col>
          <Col xs={24} xl={12} lg={24} className="mb-24">
            <SectionWrapper
            ...
            >
              <UserQuarterlyChart data={data?.services || []} />
            </SectionWrapper>
          </Col>
          <Col xs={24} xl={12} lg={24} className="mb-24">
            <SectionWrapper
            ...
            >
              <UserQuarterlyChart data={data?.quotation || []} />
            </SectionWrapper>
          </Col>
          <Col xs={24} xl={12} lg={24} className="mb-24">
            <SectionWrapper
            ...
            >
              <UserQuarterlyChart data={data?.pendingQuotation || []} />
            </SectionWrapper>
          </Col>
          <Col xs={24} xl={12} lg={24} className="mb-24">
            <SectionWrapper
            ...
            >
              <UserQuarterlyChart data={data?.supportCases || []} />
            </SectionWrapper>
          </Col>
          <Col xs={24} xl={12} lg={24} className="mb-24">
            <SectionWrapper
            ...
            >
              <UserQuarterlyChart data={data?.accPerformance || []} />
            </SectionWrapper>
          </Col>
          <Col xs={24} xl={12} lg={24} className="mb-24">
            <SectionWrapper
            ...
            >
              <UserQuarterlyChart data={data?.Onboardings || []} />
            </SectionWrapper>
          </Col>
          <Col xs={24} xl={12} lg={24} className="mb-24">
            <SectionWrapper
            ...
            >
              <UserQuarterlyChart data={data?.visitors || []} />
            </SectionWrapper>
          </Col>
        </>
      )}
...
export default QuartlyChartSection;
